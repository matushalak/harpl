...
# for i in {1..3}; do
bash bash_scripts/hRPL.sh --device "$DEVICE" --seed 1 --experiment_name animals_greedy_cts_noiseOnTop0.1_hier_pred_1 --loss pred --prediction_target enc --pred_lr_mult 10;
