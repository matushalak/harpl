...
# bash "$SCRIPT_DIR/moving_animals.sh" --device "$DEVICE" --seed 0 --experiment_name animals_cts_noiseOnTop0.1_pred_0 --loss pred --prediction_target enc --pred_lr_mult 10;
bash "$SCRIPT_DIR/moving_animals.sh" --device "$DEVICE" --seed 0 --experiment_name animals_cts_noiseOnTop0.1_lejepa_0 --loss lejepa --prediction_target enc --pred_lr_mult 10;
# for i in {1..3}; do
